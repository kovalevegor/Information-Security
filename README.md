...
Чтобы выполнить задание, можно использовать доступные данные ГОСТ Р 51275-2006 о факторах, воздействующих на информацию, и соотнести их с типовыми угрозами из общего понимания банков данных угроз ФСТЭК.
